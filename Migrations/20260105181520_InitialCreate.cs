        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodSelected = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    WaterTeaAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menus_MessGroups_MessGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMessGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserMessGroups_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMessGroups_MessGroups_MessGroupId",
                        column: x => x.MessGroupId,
                        principalTable: "MessGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillDetails_Menus_MenuId",
                        column: x => x.MenuId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Menus_EffectiveDate_MessGroupId",
                table: "Menus",
                columns: new[] { "EffectiveDate", "MessGroupId" });

            migrationBuilder.CreateIndex(
                name: "IX_Menus_MessGroupId",
                table: "Menus",
                column: "MessGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_MessGroups_Name",
                table: "MessGroups",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMessGroups_MessGroupId",
                table: "UserMessGroups",
                column: "MessGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMessGroups_UserId_MessGroupId",
                table: "UserMessGroups",
                columns: new[] { "UserId", "MessGroupId" });
        }
